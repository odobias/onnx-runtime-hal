...
#include "npu_inference_bench/runtime/execution_plan.hpp"
...
using npu_inference_bench::runtime::AdapterKind;
using npu_inference_bench::runtime::ExecutionDiagnostics;
using npu_inference_bench::runtime::ExecutionPlan;
using npu_inference_bench::runtime::GraphStage;
...
using npu_inference_bench::runtime::StageDevice;
using npu_inference_bench::runtime::Tensor;
using npu_inference_bench::runtime::TensorBinding;

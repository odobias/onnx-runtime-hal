...
# decoder + decoder_with_past) into models/whisper-tiny-en-onnx. This is the model
...
#
#   .\scripts\export-onnx-dynamic.ps1
#   .\scripts\export-onnx-dynamic.ps1 -Model openai/whisper-tiny -Out whisper-tiny-onnx

[CmdletBinding()]
param(
    [string]$Model = "openai/whisper-tiny.en",
    [string]$Out = "whisper-tiny-en-onnx"
)

...
- Private benchmark archive, `fakeaudio-logmel-precision.md` -> "NPU reality (AMD XDNA2 / VitisAI)":
...
- Private benchmark archive, `int8-vitis-quantization.md` (VitisAI int8 path).

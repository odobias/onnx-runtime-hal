# Whisper task check: static-onnx-tiny-multi-7s (npu, product window)
...
Scored against the FLEURS reference in the spoken language (`ref`). Provider: `QNNExecutionProvider`.

Source language detected: **6/6** Â· windows decoded: **11** Â· mean WER: **41.2%** Â· mean CER: **17.0%**
...
| fleurs_pl | pl | pl | 2 | 70.6% | W większość mniejszych wysp to narady nie zależne lub zpomieżone sferancją i trunące jako lub sosowe nadbalskie miejscowości wypoczynko. |

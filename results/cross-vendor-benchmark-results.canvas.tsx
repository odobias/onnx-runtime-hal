      ...
      <Grid columns="1.35fr 1fr" gap={18}>
        <Stack gap={8}>
          ...
          <BarChart
            ...
            showValues
          />
          <Caption>Source: results/ledgers/asr.csv · runs from 3–10 Jul 2026. Portable static rows use the same 12 clips / 130.47 s; Intel GenAI still uses one 5.855 s clip and a different decoder.</Caption>
        </Stack>
  ...
  return (
    <Stack gap={16}>
      ...
      <Table
        ...
        stickyHeader
      />
      <Caption>Source: results/ledgers/asr.csv. All portable static/no-KV rows now aggregate the same 12 clips / 130.47 s on battery. Intel GenAI remains a one-clip AC run with a different bounded-KV decoder.</Caption>
      ...
      <Grid columns={2} gap={18}>
        ...
        <Card>
          ...
          <CardBody>
            <Text>On the same 12 clips and static/no-KV model family, QNN NPU (0.0554) leads VitisAI NPU (0.0819), DirectML GPU (0.1004), ORT CPU (0.1041), and Intel OVEP NPU (0.1163). Host and power differences still prevent a pure silicon ranking.</Text>
          </CardBody>
        </Card>
      </Grid>

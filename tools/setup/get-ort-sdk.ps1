...
#
#   .\tools\setup\get-ort-sdk.ps1                       # DirectML, 1.24.4, x64
#   .\tools\setup\get-ort-sdk.ps1 -Version 1.24.4
#   .\tools\setup\get-ort-sdk.ps1 -Package Microsoft.ML.OnnxRuntime -Version 1.24.4   # CPU-only

...
tools/fetch/get-classifier-models.ps1 (same repo, same deepfake/* subtree) -- pick
...
NPU_INFERENCE_BENCH_MODELS_REPO=<user>/<repo> if you mirror it elsewhere.
"""
import os

# tools/research/_models.py -> repo root is three levels up.

...
Writes WAVs under --outdir (normally artifacts/workloads/speech/). Also writes a
...
Audio paths recorded in the jsonl are repo-relative:
    artifacts/workloads/speech/<id>.wav
"""
import argparse
import io
import json
...
def main() -> int:
    ...
    ap.add_argument("--outdir", required=True, help="artifacts/workloads/speech directory")
    ...
    with open(jsonl, "w", encoding="utf-8") as f:
        for i in range(n):
            ...
            rec = {
                "id": cid,
                "audio": f"artifacts/workloads/speech/{cid}.wav",
